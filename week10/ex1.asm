...
.global main
main:
    # Hi?n th? s? "6" trên LED bên trái
    li      a0, 125              # 0x7D trong h? th?p phân
    jal     SHOW_7SEG_LEFT       # G?i hàm hi?n th? bên trái

    # Hi?n th? s? "6" trên LED bên ph?i
    li      a0, 125              # 0x7D trong h? th?p phân
    jal     SHOW_7SEG_RIGHT      # G?i hàm hi?n th? bên ph?i
