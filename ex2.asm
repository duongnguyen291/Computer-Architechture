#  Duy?t m?ng 16 x 16 theo th? t? hàng (row-major order).
#  Pete Sanderson
#  31 tháng 3 n?m 2007
...
#        3. L?nh "li" ?? kh?i t?o giá tr? cho $t1 c?n thay ??i thành s? c?t m?i.
         ...
         .data
data:    .word     0 : 256       # b? nh? cho ma tr?n 16x16 c?a các t?
         .text
...
#                N?u t?ng quá hàng cu?i cùng, k?t thúc ch??ng trình.
         ...
         bne      s0, t0, loop    # ch?a ??n cu?i ma tr?n (ch?a qua hàng cu?i cùng), quay l?i vòng l?p
