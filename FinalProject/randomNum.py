...
random_numbers = generate_random_numbers(10000, -5000, 5000)

# Mở file sort.txt để ghi kết quả
with open(r'C:\Users\Admin\OneDrive\BÁCH KHOA\2024-1\Assembly Language and Computer Architecture Lab\CA\FinalProject\sortBig2.txt', 'w') as file:
